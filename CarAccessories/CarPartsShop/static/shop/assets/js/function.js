jQuery(document).ready(function (a) {
    ...
    function rhyssa_google_maps() {
        if ($('.rhyssa-google-maps').length <= 0) {
            return;
        }
        $('.rhyssa-google-maps').each(function () {
            var $this = $(this),
                $id = $this.attr('id'),
    ...
    function j() {
        ...
        if (q === true) {
            a(document).on("click", ".rhyssa-nav .menu-item-has-children >a", function (r) {
                var t = a(this).closest("li");
                var u = a(".rhyssa-nav .menu-item-has-children");
            ...
            a(document).on("click", function (r) {
                var s = a(r.target);
                if (!s.closest(".show-submenu").length || !s.closest(".rhyssa-nav").length) {
                    a(".show-submenu").removeClass("show-submenu")
                }
            })
        } else {
            a(document).on("mousemove", ".rhyssa-nav .menu-item-has-children", function () {
                a(this).addClass("show-submenu");
                if (a(this).closest(".rhyssa-nav").hasClass("main-menu")) {
                    a("body").addClass("is-show-menu")
                }
            });
            a(document).on("mouseout", ".rhyssa-nav .menu-item-has-children", function () {
